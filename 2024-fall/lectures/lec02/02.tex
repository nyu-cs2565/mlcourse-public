...
\end{itemize}
\begin{center}
\includegraphics[width=0.35\textwidth]{figures/qr_code2.png}
\end{center}
\end{frame}

\begin{frame}{Homework 1}
\begin{itemize}
\item Homework 1 will be released soon. You have until Oct 1 noon (12pm) to finish.
\item Submit PDF and code to Gradescope.
...
\begin{frame}{Error Decomposition Review}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.5\columnwidth]{figures/error-decomp}
\end{center}
...
$$\min_k \mathbb{E}[||\nabla f(x^{(k)} ||^2] \le \frac{f(x^{(0)})- f(x^*)}{\sum_k \eta_k} + \frac{L\sigma^2}{2} \frac{\sum_k \eta_k^2}{\sum_k \eta_k}$$
\end{theorem}
...
% two points middle, no difference.
% three points.
\end{itemize}
