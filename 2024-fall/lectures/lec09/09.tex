...
\title[CSCI-2565]{Random Forest and Boosting}
\author[]{Mengye Ren
\\ \quad\\
...
\begin{frame}{Slides}
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/qr_09.png}
\end{center}
\end{frame}
...
\begin{itemize}
  \item HW4 release soon. Due Dec 3, 2024 Noon.
  \item Next week guest lecture on Neural Networks I.
\end{itemize}
\end{frame}

\section{Scientific Writing II}

\begin{frame}{How to avoid sound like ChatGPT?}
Shallow content, making the focus too broad

{
\tiny
Understanding long video-language interactions represents a \textcolor{red}{transformative challenge in multimodal learning, where models must navigate extensive visual and linguistic content to extract meaningful, coherent interpretations}. Unlike short clips or single-image tasks, long videos embody intricate sequences of events, evolving contexts, and complex interactions that require sustained comprehension and nuanced understanding across time. This level of interpretation demands models capable of navigating \textcolor{red}{high-dimensional data streams, maintaining contextual awareness, and preserving coherence as they bridge connections} between video frames and corresponding language across prolonged durations. Achieving proficiency in long video-language understanding would unlock significant advancements in applications ranging from \textcolor{red}{deep narrative analysis and sports commentary to educational content summarization and assistive technologies for enhanced accessibility.}}

{\tiny
Recent advances in multimodal architectures offer glimpses of what is possible, yet long-form video comprehension \textcolor{red}{introduces unique challenges that require innovation in model design, memory retention, and temporal reasoning}. This paper explores methodologies to elevate models' capabilities in understanding \textcolor{red}{complex, continuous video narratives, emphasizing temporal alignment, memory management, and contextual coherence}. By addressing these challenges, we aim to \textcolor{red}{bridge the gap between machine processing and human-like comprehension}, enabling models to deliver richer, more consistent insights from the layered, evolving narratives found in long-form video content.
}
\end{frame}

\begin{frame}{How to avoid sound like ChatGPT?}
Grandiose word choices

{\tiny
In the \textcolor{red}{contemporary technological landscape}, Large Language Models (LLMs) are emerging as \textcolor{red}{revolutionary tools}, \textcolor{red}{driving innovations in various sectors} from healthcare to finance, and from entertainment to academia. These models, with their \textcolor{red}{unprecedented ability} to understand and generate human-like text, hold \textcolor{red}{significant promise} for \textcolor{red}{reshaping the dynamics} of human-computer interaction. However, as LLMs become more \textcolor{red}{ingrained} in everyday applications, there arises a pertinent challenge: ensuring their alignment with human values, especially when subjected to third-party finetuning.
}
\end{frame}

\begin{frame}{A few tips on how to properly use AI tools}
\begin{itemize}
  \item Brainstorm ideas
  \item Polishing, fixing grammatical mistakes, etc.
  \item ``Please help me do some light editing (only when necessary).''
  \item ``Please use scientific language and stick to fact.''
  \item Exercise a high degree of caution.
  \begin{itemize}
    \item Do I really need to write about this? Do I really mean it?
    \item Be critical. Always give feedback to chat bot and do another round.
  \end{itemize}
\end{itemize}
\end{frame}
