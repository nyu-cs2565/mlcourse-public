...
\note<.>{Let $K=\vert\sY\vert$, DP2 runtime $O(K^2L)$, $m$th order Markov feature has runtime $O(K^mL)$, naive runtime $O(K^L)$.}
\end{description}
...
\begin{itemize}
  ...
  \item We contrast between the data expectation and the model expectation.
  \pause
...
\begin{center}
\includegraphics[width=0.35\textwidth]{figures/pos_tag.png}
\includegraphics[width=0.35\textwidth]{figures/semantic_seg.png}
\includegraphics[width=0.27\textwidth]{figures/deep_structured.png}
\end{center}

\begin{flushright}
{\tiny Chen et al. Learning Deep Structured Models. ICML 2015.}
\end{flushright}
\end{frame}
