...
\pause
\[
\sum_i (w^T x_i - y_i) x_{i,j} + \lambda \frac{|\hat{w}_j|}{\hat{w}_j} = 0\]
\pause
\[
\sum_i (\hat{w}_j x_{i,j} + w_{-j}^T x_{i,-j} - y_i) x_{i,j} + \lambda \frac{|\hat{w}_j|}{\hat{w}_j} = 0 \]
\pause
\[\hat{w}_j \sum_i x_{i,j}^2 + \sum_i (w_{-j}^T x_{i,-j} - y_i) x_{i,j} + \lambda \frac{|\hat{w}_j|}{\hat{w}_j} = 0 \]
\end{frame}
...
\[
\hat{w}_j \textcolor{red}{\underbrace{\sum_i x_{i,j}^2}_{a_j}} - \textcolor{blue}{\underbrace{\sum_i (y_i - w_{-j}^T x_{i,-j} ) x_{i,j}}_{c_j}} + \lambda \frac{|\hat{w}_j|}{\hat{w}_j} = 0 \]
\pause
\[
