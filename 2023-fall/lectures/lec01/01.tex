...
\title[CSCI-GA 2565]{Course Overview}
\author{Mengye Ren}
...
\item Graders:
    \begin{itemize}
        \item Shreya Agarwal (\texttt{sa6981@nyu.edu})
        \item Jash Rathod ({\texttt{jsr10000@nyu.edu}})
    \end{itemize}
...
\begin{itemize}
\item Groups of maximum three.
\item The goal is to apply the ML algorithms in real applications.
\item Goals:
\begin{itemize}
\item Find or collect a dataset (can be related to your area of study/research)
\item Survey existing approaches
\item Implement a set of ML algorims and compare their performance
\end{itemize}
\item Project proposal due Friday, Oct 27, 2023, 11:59PM
\item Last lecture: 3min project presentation
\item Final report due Wednesday, Dec 15, 2023, 11:59PM
\end{itemize}
\end{frame}
...
\begin{frame}{Relations to human learning}
  \begin{itemize}
    ...
    \pause
    \item It may borrow ideas from biological systems (e.g. neural networks).
    \pause
...
\begin{frame}{History of machine learning}
  ...
  \item 1990s --- the ``AI Winter'', a time of pessimism and low funding
    \pause
  \item A lot of practical ML algorithms were invented in the 90s.
    \begin{itemize}
  ...
  \item 2010s --- deep learning
    \begin{itemize}
    \item 2010--2012 --- neural nets smashed previous records in speech-to-text and object recognition
    \item increasing adoption by the tech industry
...
\begin{itemize}
\item In ML problems, we generally need to:
\begin{itemize}
...
A \textbf{loss function} evaluates the output in the context of the true outcome $y$.
