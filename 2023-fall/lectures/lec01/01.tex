...
\end{itemize}
\item Discussion / questions on CampusWire: \url{https://campuswire.com/p/G74AFD6C8} \\
\includegraphics[width=0.4\textwidth,trim={0 5cm 0 0},clip]{figures/campuswire.png}
% \url{https://campuswire.com/p/G74AFD6C8}
\item Sign up to Gradescope to submit homework assignments (entry code \textbf{RZJR36})
\end{itemize}
\begin{itemize}
...
\begin{itemize}
\item Groups of maximum three students.
\item Goals:
\begin{itemize}
\item Find or collect a dataset (can be related to your area of study/research)
\item Survey existing approaches
\item Apply a set of ML algorithms in real applications
\item Compare and analyze performance
\end{itemize}
\item Project rubric will be posted.
