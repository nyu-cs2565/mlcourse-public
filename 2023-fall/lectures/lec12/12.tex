...
\begin{frame}{End of the course}
\begin{itemize}
    \item Congrats, you are almost done.
    \item Originally developed by Prof. David Rosenberg (now at Bloomberg).
    \item Later adapted by Prof. He He and other colleagues.
    \item Added my twists on the topics.
    \item A very challenging course.
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item Aim for 3 mins per group, hard stop at 4 mins, and 1 min Q\&A.
    \item Send me your slides in PDF with your group number by Dec 14 11:59pm.
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item DL is not necessarily good for all types of data (availability, data quality, data modality etc.).
    \item Classic methods also have their sweet spots.
    \item Classic ML lays down foundation when building innvoative DL algorithm.
